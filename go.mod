...
require (
	dev.azure.com/ciaalicorp/CIA-Funciones/cia-library-domain-alicorp.git v0.3.2
	dev.azure.com/ciaalicorp/CIA-Funciones/cia-library-extension-rkgin-common.git/v2 v2.7.6
	dev.azure.com/ciaalicorp/CIA-Funciones/cia-library-extension-rkgin-tracing.git/v2 v2.3.0
	dev.azure.com/ciaalicorp/CIA-Funciones/cia-library-repository-odl.git v0.5.4
